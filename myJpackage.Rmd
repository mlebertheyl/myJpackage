...
The puropose was to make a fun package, specially by making it friendly and also useful. The main idea was to gain a better understanding of the structure of JAGS code, and to use it as a reminder later on, since JAGS and R structure and code differ a little.
